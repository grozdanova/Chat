...
(function () {
  ...
  17: [function (_dereq_, module, exports) {
    ...
    var at = _dereq_(110)(true); // `AdvanceStringIndex` abstract operation
  ...
  28: [function (_dereq_, module, exports) {
    ...
    var TAG = _dereq_(133)('toStringTag'); // ES3 wrong here
  ...
  40: [function (_dereq_, module, exports) {
    ...
    var document = _dereq_(51).document; // typeof document.createElement is 'object' in old IE
  ...
  55: [function (_dereq_, module, exports) {
    module.exports = !_dereq_(39) && !_dereq_(45)(function () {
      return Object.defineProperty(_dereq_(40)('div'), 'a', {
        get: function get() {
          return 7;
        }
      }).a != 7;
  ...
  58: [function (_dereq_, module, exports) {
    ...
    var cof = _dereq_(29); // eslint-disable-next-line no-prototype-builtins
  ...
  65: [function (_dereq_, module, exports) {
    ...
    _dereq_(53)(IteratorPrototype, _dereq_(133)('iterator'), function () {
      return this;
    });
  ...
  110: [function (_dereq_, module, exports) {
    ...
    var defined = _dereq_(38); // true  -> String#at
  ...
  124: [function (_dereq_, module, exports) {
    ...
    var isObject = _dereq_(62); // instead of the ES6 spec version, we didn't implement @@toPrimitive case
  ...
  142: [function (_dereq_, module, exports) {
    ...
    $export($export.S + $export.F * !_dereq_(67)(function (iter) {
      Array.from(iter);
    }), 'Array', {
  ...
  145: [function (_dereq_, module, exports) {
    ...
    var toIObject = _dereq_(121); // 22.1.3.4 Array.prototype.entries()
  ...
  149: [function (_dereq_, module, exports) {
    ...
    var createProperty = _dereq_(34); // WebKit Array.of isn't generic
  ...
  157: [function (_dereq_, module, exports) {
    ...
    var toISOString = _dereq_(36); // PhantomJS / old WebKit has a broken implementations
  ...
  182: [function (_dereq_, module, exports) {
    ...
    if (!$Number(' 0o1') || !$Number('0b1') || $Number('+0x1')) {
      ...
      for (var keys = _dereq_(39) ? gOPN(Base) : ( // ES3:
  ...
  190: [function (_dereq_, module, exports) {
    ...
    var $parseFloat = _dereq_(93); // 20.1.2.12 Number.parseFloat(string)
  ...
  191: [function (_dereq_, module, exports) {
    ...
    var $parseInt = _dereq_(94); // 20.1.2.13 Number.parseInt(string, radix)
  ...
  192: [function (_dereq_, module, exports) {
    ...
    $export($export.P + $export.F * (!!$toFixed && (0.00008.toFixed(3) !== '0.000' || 0.9.toFixed(0) !== '1' || 1.255.toFixed(2) !== '1.25' || 1000000000000000128.0.toFixed(0) !== '1000000000000000128') || !_dereq_(45)(function () {
      // V8 ~ Android 4.3-
      $toFixed.call({});
    })), 'Number', {
  ...
  195: [function (_dereq_, module, exports) {
    var $export = _dereq_(43); // 19.1.2.2 / 15.2.3.5 Object.create(O [, Properties])
  ...
  196: [function (_dereq_, module, exports) {
    var $export = _dereq_(43); // 19.1.2.3 / 15.2.3.7 Object.defineProperties(O, Properties)


    $export($export.S + $export.F * !_dereq_(39), 'Object', {
      defineProperties: _dereq_(81)
    });
  }, {
    "39": 39,
    "43": 43,
  ...
  197: [function (_dereq_, module, exports) {
    var $export = _dereq_(43); // 19.1.2.4 / 15.2.3.6 Object.defineProperty(O, P, Attributes)


    $export($export.S + $export.F * !_dereq_(39), 'Object', {
      defineProperty: _dereq_(80).f
    });
  }, {
    "39": 39,
    "43": 43,
  ...
  209: [function (_dereq_, module, exports) {
    ...
    $export($export.S, 'Object', {
      setPrototypeOf: _dereq_(103).set
    });
  }, {
    "103": 103,
    "43": 43
  ...
  211: [function (_dereq_, module, exports) {
    ...
    var $parseFloat = _dereq_(93); // 18.2.4 parseFloat(string)
  ...
  212: [function (_dereq_, module, exports) {
    ...
    var $parseInt = _dereq_(94); // 18.2.5 parseInt(string, radix)
  ...
  213: [function (_dereq_, module, exports) {
    ...
    Wrapper = _dereq_(33)[PROMISE]; // statics
  ...
  215: [function (_dereq_, module, exports) {
    ...
    var rConstruct = (_dereq_(51).Reflect || {}).construct; // MS Edge supports only 2 arguments and argumentsList argument is optional
  ...
  216: [function (_dereq_, module, exports) {
    ...
    var toPrimitive = _dereq_(124); // MS Edge has broken Reflect.defineProperty - throwing instead of returning false
  ...
  228: [function (_dereq_, module, exports) {
    ...
    if (_dereq_(39) && (!CORRECT_NEW || _dereq_(45)(function () {
      re2[_dereq_(133)('match')] = false; // RegExp constructor can alter flags and IsRegExp works correct with @@match
  ...
  231: [function (_dereq_, module, exports) {
    ...
    var regExpExec = _dereq_(100); // @@match logic
  ...
  233: [function (_dereq_, module, exports) {
    ...
    var regExpExec = _dereq_(100); // @@search logic
  ...
  249: [function (_dereq_, module, exports) {
    ...
    var $at = _dereq_(110)(true); // 21.1.3.27 String.prototype[@@iterator]()
  ...
  259: [function (_dereq_, module, exports) {
    ...
    $Symbol[PROTOTYPE][TO_PRIMITIVE] || _dereq_(53)($Symbol[PROTOTYPE], TO_PRIMITIVE, $Symbol[PROTOTYPE].valueOf); // 19.4.3.5 Symbol.prototype[@@toStringTag]
  ...
  271: [function (_dereq_, module, exports) {
    ...
    var $WeakMap = module.exports = _dereq_(32)(WEAK_MAP, wrapper, methods, weak, true, true); // IE11 WeakMap frozen keys fix
  ...
  279: [function (_dereq_, module, exports) {
    ...
    var userAgent = _dereq_(129); // https://github.com/zloirock/core-js/issues/280
